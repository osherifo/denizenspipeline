...
Stores both single-run and batch conversion configs in ~/.denizens/convert_configs/
...
DEFAULT_DIR = Path.home() / ".denizens" / "convert_configs"
...
class ConvertConfigStore:
    ...
    def save_from_batch_params(self, params: dict, name: str = "", description: str = "") -> dict:
        ...
        from denizenspipeline.convert.batch import BatchConfig, BatchJobConfig, batch_config_to_dict
