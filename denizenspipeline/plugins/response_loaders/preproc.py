...
from denizenspipeline.plugins.response_loaders.local import (
    LocalResponseLoader,
    _NO_MASK,
)
...
class PreprocResponseLoader:
    ...
    def load(self, config: dict) -> ResponseData:
        from denizenspipeline.preproc.manifest import PreprocManifest, ConfoundsConfig
        ...
        for run in manifest.runs:
            ...
            if confounds_cfg and run.confounds_file:
                from denizenspipeline.preproc.confounds import regress_confounds
