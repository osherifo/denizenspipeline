...
from fmriflow.convert.dicom_utils import extract_scanner_info
from fmriflow.convert.errors import ConvertError, HeudiconvError
from fmriflow.convert.heuristics import build_heuristic_ref, resolve_heuristic
...
def _parse_bids_filename(filename: str) -> dict[str, str]:
    ...
    e.g. "sub-AN_ses-20170607AN_task-reading_run-01_bold.nii.gz"
    → {"sub": "AN", "ses": "20170607AN", "task": "reading", "run": "01"}
    """
